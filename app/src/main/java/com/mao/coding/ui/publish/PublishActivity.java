...
public class PublishActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void enqueue(List<OneTimeWorkRequest> workRequests) {
        WorkContinuation workContinuation = WorkManager.getInstance(com.mooc.ppjoke.ui.publish.PublishActivity.this).beginWith(workRequests);
        workContinuation.enqueue();

        workContinuation.getWorkInfosLiveData().observe(
            com.mooc.ppjoke.ui.publish.PublishActivity.this, new Observer<List<WorkInfo>>() {
            @Override
        ...
        ApiService.post("/feeds/publish")
                ...
                .execute(new JsonCallback<JSONObject>() {
                    ...
                    public void onSuccess(ApiResponse<JSONObject> response) {
                        ...
                        com.mooc.ppjoke.ui.publish.PublishActivity.this.finish();
                        dismissLoading();
                    }
    ...
    private void showToast(String message) {
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(com.mooc.ppjoke.ui.publish.PublishActivity.this, message, Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
...
//                .keepResultsForAtLeast(10, TimeUnit.SECONDS)
    ...
    private void showFileThumbnail() {
        ...
        mBinding.cover.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PreviewActivity.startActivityForResult(com.mooc.ppjoke.ui.publish.PublishActivity.this, filePath, isVideo, null);
            }
        });
    }
